    ...
    <form action="proses_input.php" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <select id="genreSelect">
                ...
                <option value="Hisroty">Hisroty</option>
        ...
        <ul id="selectedGenres" class="mt-3 list-group d-flex flex-wrap" style="max-heigth: 200px; overflow-y: auto;"></ul>
        ...
        <div>
        <label for="banner">Total Menit</label>
        ...
        <div>
         <label for="dustributor">Producer</label>
